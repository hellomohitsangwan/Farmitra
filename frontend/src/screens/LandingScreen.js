      ...
      <section>
        <div className="sec secUp" id="sec">
          ...
          <p>
            ...
            assumenda suscipit quibusdam sint quisquam itaque animi ab deleniti
            obcaecati adipisci repudiandae fugiat nostrum non. Doloremque natus
            sed voluptates blanditiis magnam deserunt iste ratione expedita!
            Dolore ut, perferendis aperiam iste natus dolorum similique enim
            beatae expedita nemo error, obcaecati iusto assumenda architecto
            tempora perspiciatis nam velit. Dicta accusamus doloremque dolorum
            porro natus, eos beatae neque voluptate odio recusandae ex, nobis
            eaque dolor cumque? Consequuntur aspernatur vero ad facere deleniti
            ullam, rerum expedita fugit nemo optio ex ea! Quibusdam vel debitis
            architecto dolorem sed ipsam excepturi nesciunt, libero illum! Quasi
            consequatur accusamus libero maiores! Eum eligendi quibusdam, fugit,
            nobis doloremque voluptatibus at nemo eveniet illo aut corporis,
            impedit similique repudiandae officiis. Corrupti modi ex possimus
            architecto ratione repudiandae officia corporis est ab facilis
            reprehenderit amet incidunt, magnam illo eaque, sapiente error.
          </p>
        </div>
        {/*============================ show case ===================== */}
        <showcase>
